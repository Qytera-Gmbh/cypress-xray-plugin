...
| `OPENSSL_SECURE_OPTIONS` | Set it to a number that will be used to configure the [`securityOptions`](https://nodejs.org/api/https.html#httpsrequesturl-options-callback) (see below) of the [`https.Agent`](https://nodejs.org/api/https.html#class-httpsagent) used for sending requests to your Jira Xray instance. |
