...
import { BaseJiraClient, JiraClient } from "./jira-client";
...
describe("the jira clients", () => {
    ...
    beforeEach(() => {
        ...
        client = client = new BaseJiraClient(
            "https://example.org",
    ...
    describe("search", () => {
        ...
        it("handles bad responses", async () => {
            ...
            expect(logger.logErrorToFile).to.have.been.calledOnceWithExactly(error, "searchError");
        });
    });
    ...
    describe("editIssue", () => {
        ...
        it("handles bad responses", async () => {
            ...
            expect(logger.logErrorToFile).to.have.been.calledOnceWithExactly(error, "editIssue");
        });
    });
