...
import { GetSummaryValuesCommand } from "./getSummaryValuesCommand";
    ...
    describe(GetSummaryValuesCommand.name, () => {
        it("fetches summaries", async () => {
            ...
            jiraClient.search
                ...
                .resolves([
                    { key: "CYP-123", fields: { ["customfield_12345"]: "Hello" } },
                    { key: "CYP-456", fields: { ["customfield_12345"]: "Good Morning" } },
                    { key: "CYP-789", fields: { ["customfield_12345"]: "Goodbye" } },
                ]);
