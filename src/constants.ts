...
export const ENV_JIRA_FIELDS_DESCRIPTION_ID = "JIRA_FIELDS_DESCRIPTION_ID";
export const ENV_JIRA_FIELDS_DESCRIPTION_NAME = "JIRA_FIELDS_DESCRIPTION_NAME";
export const ENV_JIRA_FIELDS_LABELS_ID = "JIRA_FIELDS_LABELS_ID";
export const ENV_JIRA_FIELDS_LABELS_NAME = "JIRA_FIELDS_LABELS_NAME";
export const ENV_JIRA_FIELDS_SUMMARY_ID = "JIRA_FIELDS_SUMMARY_ID";
export const ENV_JIRA_FIELDS_SUMMARY_NAME = "JIRA_FIELDS_SUMMARY_NAME";
export const ENV_JIRA_FIELDS_TEST_PLAN_ID = "JIRA_FIELDS_TEST_PLAN_ID";
export const ENV_JIRA_FIELDS_TEST_PLAN_NAME = "JIRA_FIELDS_TEST_PLAN_NAME";
export const ENV_JIRA_FIELDS_TEST_TYPE_ID = "JIRA_FIELDS_TEST_TYPE_ID";
export const ENV_JIRA_FIELDS_TEST_TYPE_NAME = "JIRA_FIELDS_TEST_TYPE_NAME";
