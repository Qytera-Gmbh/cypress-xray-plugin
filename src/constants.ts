...
export const ENV_JIRA_FIELDS_DESCRIPTION = "JIRA_FIELDS_DESCRIPTION";
export const ENV_JIRA_FIELDS_LABELS = "JIRA_FIELDS_LABELS";
export const ENV_JIRA_FIELDS_SUMMARY = "JIRA_FIELDS_SUMMARY";
export const ENV_JIRA_FIELDS_TEST_ENVIRONMENTS = "JIRA_FIELDS_TEST_ENVIRONMENTS";
export const ENV_JIRA_FIELDS_TEST_PLAN = "JIRA_FIELDS_TEST_PLAN";
export const ENV_JIRA_FIELDS_TEST_TYPE = "JIRA_FIELDS_TEST_TYPE";
...
export const ENV_XRAY_TEST_ENVIRONMENTS = "XRAY_TEST_ENVIRONMENTS";
