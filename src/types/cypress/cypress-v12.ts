...
// ============================================================================================== //
// See: https://github.com/cypress-io/cypress/blob/v12.17.4/cli/types/cypress-npm-api.d.ts
// ============================================================================================== //
...
// ============================================================================================== //
// See: https://github.com/cypress-io/cypress/blob/v12.17.4/cli/types/cypress.d.ts
// ============================================================================================== //
...
export interface ResolvedConfigOptions<ComponentDevServerOpts = any> {
    ...
    retries: Nullable<{ openMode?: Nullable<number>; runMode?: Nullable<number> } | number>;
...
export interface PluginEvents {
    ...
    (
        ...
        ) => BrowserLaunchOptions | Promise<BrowserLaunchOptions> | undefined
    ): void;
