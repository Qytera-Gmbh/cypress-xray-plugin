...
interface ResolvedConfigOptions<ComponentDevServerOpts = unknown> {
    baseUrl: string | null;
    env: { [key: string]: unknown };
...
>;
type ConfigOptions<ComponentDevServerOpts = unknown> = Partial<
...
declare namespace Mocha {
    ...
    interface PendingSuiteFunction {
        (
            title: string,
            config: Cypress.SuiteConfigOverrides,
            fn: (this: Suite) => void
        ): Suite | void;
    }
}
